...
class Tellor360Reporter(Stake):
    ...
    async def check_reporter_lock(self) -> ResponseStatus:
        ...
        try:
            reporter_lock = 0 / math.floor(staker_balance / current_stake_amount)
    ...
    async def ensure_profitable(self) -> ResponseStatus:
        ...
        price_feeds = [native_token_feed, stb_usd_median_feed]
        ...
        price_stb_usd = stb_usd_median_feed.source.latest[0]

        if price_native_token is None or price_stb_usd is None:
